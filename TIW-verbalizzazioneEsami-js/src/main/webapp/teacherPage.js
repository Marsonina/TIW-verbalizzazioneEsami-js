...
function StudentsList (_title,_studentscontainer, _studentslist) {
  ...
  //makes studentsList and buttons invisible
  this.reset = function() {
...
function MultipleModify(_modifycontainer, _modifystudents){
  ...
  //makes multiple modify option invisible		
  this.reset = function() {
